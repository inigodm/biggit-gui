...
public class MainWindow {
  ...
  private void mnCloneActionPerformed(ActionEvent e) {
    runAsyncLogged(git::status, (it) -> infoBox("hecho", "msg"));
  }

  private void runAsyncLogged(Supplier<String> supplier, Consumer<String> consumer) {
    new AsyncRunner().runAsync(() -> runLogged(supplier), consumer);
  }

  private String runLogged(Supplier<String> supplier) {
  ...
  public void infoBox(String infoMessage, String titleBar) {
    JOptionPane.showInternalMessageDialog(null, infoMessage, titleBar, JOptionPane.INFORMATION_MESSAGE);
  }
